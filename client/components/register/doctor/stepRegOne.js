...
const StepRegOne = ({ moveSteps, setExistEmail, setRegStepOne }) => {
  ...
  return (
    <div className={reg.steps_forms}>
      <h5>
        <b className={reg.stepHead}>Step - 1/2</b>
      </h5>
      <h2>1. Please fill your basic information</h2>
