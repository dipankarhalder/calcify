...
import { LOGIN_PATIENT, LOGIN_DOCTOR } from "@/coreRoutes";
  ...
  return (
    <Suspense fallback={<p>Loading...</p>}>
      <Head>
        ...
        <meta name="keywords" content="Login Patient" />
        <meta name="description" content="Login Patient" />
      </Head>
      <section className={core.app_auth_wrapper}>
        <div className={login.app_patient_content}>
          <Logo />
